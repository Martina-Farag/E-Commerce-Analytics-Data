...
const Cards = () => {
  ...
  return (
    <div className="Cards lg:mb-8 my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5  justify-end gap-4 bg-white dark:bg-slate-800">
      {/* Global Card */}
      <div className="h-full  md:col-span-2 mb-4 lg:m-1 py-8 lg:p-8 px-6 space-y-6 rounded-xl bg-white dark:bg-[#ffffff14]">
        <svg
          className="w-40 mx-auto opacity-75"
          viewBox="0 0 146 146"
          fill="none"
        ...
        <div>
          <h5 className="text-xl text-gray-600 dark:text-white text-center">
            Total Income
          </h5>
        ...
        <table className="w-full text-gray-600 dark:text-white">
          <tbody>
            <tr>
              <td className="py-2">Products</td>
              <td className="text-gray-500 dark:text-white">
                {productsNumber}
              </td>
              <td>
                <svg
            ...
            <tr>
              ...
              <td className="text-gray-500 dark:text-white">{usersNumber}</td>
              <td>
                <svg
                  className="w-16 ml-auto"
                  viewBox="0 0 68 21"
            ...
            <tr>
              <td className="py-2">Carts</td>
              <td className="text-gray-500 dark:text-white">{cartsNumber}</td>
              <td>
                <svg
                  className="w-16 ml-auto"
                  viewBox="0 0 68 21"
      ...
      {/* first card */}
      <div className="lg:h-full md:pt-20   lg:m-1 py-6 px-2 text-gray-600 rounded-xl bg-white dark:bg-[#ffffff14]">
        <svg
          className="w-40 mx-auto opacity-75"
          viewBox="0 0 146 146"
          fill="none"
        ...
        >
          ...
          <defs>
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color="#0480de" />
              <stop offset="1" stop-color="#04c788" />
            </linearGradient>
        ...
        <div className="mt-6">
          {/* <h3 class="text-3xl font-bold text-gray-700">{productsNumber}</h3> */}
          <h5 className="text-xl text-gray-700 dark:text-white text-center">
          ...
          <div className="mt-2 flex justify-center ">
            ...
            <div className="flex items-end gap-1 text-blue-500">
              ...
              {/* <span >{Math.round(totalProductsPrice)}</span> */}
            </div>
          </div>
          <span className="block text-center text-gray-500 dark:text-white">
      ...
      <div className="lg:h-full md:pt-20   lg:m-1 py-6 px-2 text-gray-600 rounded-xl bg-white dark:bg-[#ffffff14]">
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 flex justify-center ">
            ...
            <div className="flex items-end gap-1 text-blue-500"></div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:h-full md:pt-20   lg:m-1 py-6 px-2 text-gray-600 rounded-xl bg-white dark:bg-[#ffffff14]">
        ...
        <div className="mt-6">
          ...
          <span className="text-[#FFD422]">{totalSalesNumber}</span>
        </div>
      </div>

      {/* forth card */}
      {/* <div className="lg:h-full grid items-center gap-0 py-3 px-2 text-gray-600 rounded-xl border bg-white dark:bg-[#ffffff14]">
                    <svg className="w-40 mx-auto" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
